...
\begin{enumerate}
    ...
    \item $L(\mathcal{G}) \subseteq L$, tj. $\mathcal{G}$ nevygeneruje nic navíc.
        ...
        Tedy z $S$ je možné vygenerovat pouze $0^i S 1^j$, $0 \leq i \leq j$, a tedy \mbox{S \Rightarrow^\star 0^i S 1^j \xRightarrow{S \rightarrow \varepsilon} 0^i 1^j, 0 \leq i \leq j}.
