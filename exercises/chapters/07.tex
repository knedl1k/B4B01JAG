...
% \bb{7. odstraňuji paralelní hrany:}
...
%     \path[->]
%     (S) edge [bend left] node {$\varepsilon$} (1)
%     (1) edge [bend left] node {$(a^{\star}ba(ba)^{\star}a)^{\star}(a^{\star}+(a^{\star}ba(ba)^{\star}))$}
%     (F)
%     ;    
% \end{tikzpicture}
