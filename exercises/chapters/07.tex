    ...
    \begin{minipage}[c]{0.7\textwidth}
        ...
        \begin{tikzpicture}[scale=0.8]
            ...
            \path[->]
                ...
                (2) edge [bend left] node[above] {$b$} (4)
                ...
                (4) edge [bend left] node[left] {$b$} (5)
...
\columnbreak
    ...
    \begin{tikzpicture}[shorten >=1pt,node distance=22mm,on grid,auto]
        ...
        \path[->]
        (S) edge [bend left] node {$\varepsilon$} (1)
        (1) edge [bend right] node[below] {$(a^{\star}ba(ba)^{\star}a)^{\star}(a^{\star}+(a^{\star}ba(ba)^{\star}))$}
        (F)
        ;
    \end{tikzpicture}
...
4. spojím obsah smyček, \\odstraním smyčku a node:
