...
\begin{tikzpicture}[scale=0.6]
    ...
    \node[state, accepting, left of=5] (f) {$q_f$};
    ...
    \draw
        ...
        (4) edge[bend left] node{$a, Y / \varepsilon$} (5)
        (5) edge[loop right] node{$a, Y / \varepsilon$} (5)
        (5) edge[bend left] node{$\varepsilon, Z_0 / \varepsilon$} (f)
        ;
\end{tikzpicture}
