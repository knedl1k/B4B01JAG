...
\begin{multicols}{2}
  ...
  \end{tikzpicture}
    ...
    ${(q_0, 011000, Z_0) \vdash (q_0, 11000, A Z_0) \vdash} \\ 
    (q_1, 1000, A Z_0) \vdash (q_1, 000, A Z_0)$
    \begin{flalign*}
        \vdash (q_2, 00, A Z_0) &\vdash (q_f, 0, A Z_0) \xmark & \\
        &\vdash (q_2, 0, Z_0) \rightarrow
    \end{flalign*}
    \begin{flalign*}
        \rightarrow(q_2, 0, Z_0) &\vdash (q_f, 0, Z_0) \xmark & \\
...
\begin{flalign*}
    ...
    ababababS \stackrel{2.}{\Longrightarrow} & \\ 
    & ababababbA \stackrel{4.}{\Longrightarrow} ababababba
\end{flalign*}
